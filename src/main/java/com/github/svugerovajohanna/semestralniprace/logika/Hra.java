...
public class Hra implements IHra {
    ...
    public Hra() {
        ...
        platnePrikazy.vlozPrikaz(new PrikazVyhod(herniPlan, kapsa));
        platnePrikazy.vlozPrikaz(new PrikazMluv(herniPlan, dovednosti));
        platnePrikazy.vlozPrikaz(new PrikazProzkoumej(herniPlan));
        platnePrikazy.vlozPrikaz(new PrikazKapsa(herniPlan, kapsa));
        platnePrikazy.vlozPrikaz(new PrikazDovednosti(herniPlan, dovednosti));
    ...
    public String vratUvitani() {
        ...
        "Toto je příběh o Harry Potterovi.\n" +
        "Vaším úkolem je získat Kámen mudrců.\n" +
